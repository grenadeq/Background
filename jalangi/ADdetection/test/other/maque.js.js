...
oScrollMid.parentNode.insertBefore(oScrollMid.cloneNode(true),oScrollMid.nextSibling); 
...
ScrollUpDown: function() { 
	...
	this.scroller.scrollTop = this.scrollTop = this.GetScroll(this.scrollTop, this.heightScroller, this.heightlist, 
	this.options.PauseHeight); 
	if(isNaN(this.scrollTop))return;
