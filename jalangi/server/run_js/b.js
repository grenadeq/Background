...
//main API
var path="../js/rls-e9f7b9f3.js";
//ŽËŽŠÓÃÓÚœÓÊÕÌáÈ¡µÄjsÎÄŒþ
        var finalOutput = main(path);
        //var outputFile = "../output/result.txt";
//œ«ÌáÈ¡³öÀŽµÄÌØÕ÷ÏòÁ¿ÐŽÈëÎÄŒþ£¬µœÕýÊœÔËÐÐÊ±Ê¡È¥žÃ²œÖè
...
//console.log(beta);
        ...
        //console.log(z);
//Ä¿Ç°ÌØÕ÷¹²21žö£¬ÑµÁ·³öÀŽµÄÏòÁ¿Îª21x1
        z = Math.exp(z) + 1;
        //console.log(z);
        z = 1 / z;
        //console.log(z);
        ...
        if (z >= 0.5) {
         ...
         //   console.log("other\n");
           ...
           var end=(new Date()).getMilliseconds();
            var time=end-begin;
console.log(end);
            console.log("Extraction time is="+time);
    ...
    function main(inputFile) {
        var finalOutput = "";
        var fullFilePath = inputFile;//²»ÔÙÓÐinputÎÄŒþŒÐ£¬¶øÊÇœöœöŽ«¹ýÀŽÒ»žöÐèÒª²âÊÔµÄjsÎÄŒþ
    ...
    function compositeResult(recordTables) {
        ...
        return output;//ÉŸÈ¥Žò±êŒÇµÄ¹ý³Ì£¬ÒòÎªÖ»ÓÐÌØÕ÷ÏòÁ¿
    }
